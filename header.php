    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 fh5co_mediya_center"><a href="#" class="color_fff fh5co_mediya_setting"><i
                        class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;<?php echo date('Y, M, d') ?></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="images/logo.png" alt="Logo" class="fh5co_logo_width" />
            </div>
            ...
            <div class="col-12 col-md-3 align-self-center">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <!-- Twitter -->
                    <a href="https://twitter.com/fh5co" target="_blank" class="mx-2">
                        <i class="fa fa-twitter"></i>
                    </a>
                    <!-- Facebook -->
                    <a href="https://fb.com/fh5co" target="_blank" class="mx-2">
                        <i class="fa fa-facebook"></i>
                    </a>
                    <!-- Dropdown Ngôn Ngữ -->
                    <select class="form-control ml-3" style="width: auto;">
